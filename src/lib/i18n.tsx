...
const dict: Record<Lang, Dict> = {
  es: {
    ...
    "hero.eyebrow": "Estudio de diseño + automatización",
    "hero.title": "Webs inteligentes y automatización para negocios que quieren crecer.",
    "hero.subtitle": "Diseño, automatización y agentes IA para captar clientes y ahorrar tiempo. Construimos sistemas, no solo páginas.",
    ...
    "value.body": "Combinamos diseño editorial, automatización y agentes IA para que tu negocio capte, agende y atienda clientes sin que tengas que estar delante.",
    "value.p1.title": "Diseño que vende",
    "value.p1.body": "Tipografía cuidada, jerarquía clara y CTAs pensados para convertir.",
    "value.p2.title": "Automatización real",
    "value.p2.body": "Flujos en n8n y APIs que hacen el trabajo aburrido por ti.",
    "value.p3.title": "Agentes IA",
    "value.p3.body": "Asistentes que responden, agendan y filtran clientes 24/7.",
    "value.p4.title": "Datos, no humo",
    "value.p4.body": "Medimos cada clic, cada reserva, cada conversación.",

    "demos.eyebrow": "Showroom",
    "demos.title": "Demos en vivo. Toca, prueba, imagina.",
    "demos.body": "Cada demo es una versión real navegable de lo que tu negocio podría tener funcionando esta semana.",
    "demos.view": "Ver demo",
    ...
    "pricing.ai.tag": "Agentes IA y automatización",

    "cases.eyebrow": "Casos de uso",
    "cases.title": "Hecho para quien atiende, no para quien teoriza.",
    ...
    "process.title": "Un proceso, cuatro movimientos.",
    "process.s1.t": "Diagnóstico",
    "process.s1.b": "Entendemos tu negocio, tu cliente y dónde estás perdiendo tiempo o dinero.",
    "process.s2.t": "Diseño",
    "process.s2.b": "Construimos la presencia digital que tu marca merece.",
    "process.s3.t": "Automatización",
    "process.s3.b": "Conectamos calendarios, mensajes y agentes IA al sistema.",
    "process.s4.t": "Escalado",
    "process.s4.b": "Iteramos con datos reales y multiplicamos lo que funciona.",

    "test.eyebrow": "Quienes ya confiaron",
    "test.title": "Resultados que se ven en la agenda.",

    "lead.eyebrow": "Auditoría gratuita",
    "lead.title": "Te decimos exactamente qué está frenando tu negocio.",
