...
const dict: Record<Lang, Dict> = {
  ...
  en: {
    ...
    "ps.p2.title": "You answer the same questions 100 times",
    "ps.p2.desc": "WhatsApp, email, calls — always the same doubts. You waste hours explaining the same thing over and over.",
    "ps.p3.title": "You lose sales after hours",
    "ps.p3.desc": "40% of inquiries arrive after 8pm or on weekends. By the time you reply, they've already hired someone else.",
    "ps.solution.eyebrow": "The solution",
    "ps.solution.title": "We fix it with systems, not with design.",
    "ps.s1.title": "Lead capture automation",
    "ps.s1.desc": "Smart forms that qualify leads automatically and send them straight to your CRM.",
    "ps.s2.title": "AI that works 24/7",
    "ps.s2.desc": "Chatbot that answers questions, books appointments and closes simple sales — even at 3am.",
    "ps.s3.title": "Metrics that matter",
    "ps.s3.desc": "Dashboard with conversions, traffic sources and real ROI — no vanity metrics.",
    "nav.cta": "Book a call",
